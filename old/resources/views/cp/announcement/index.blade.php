@extends($route.'.main')
@section ('section-title', 'All Announcements')
		...
		<tbody>
			...
			@foreach ($data as $row)
				<tr>
					...
					<td>
						@if($row->image!="")
							<img src="{{ asset ('public/uploads/announcement/image/'.$row->image) }}" style="max-width:250px" alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $row->name }}">
						@else
							No Image Avaiable
						@endif
					</td>
