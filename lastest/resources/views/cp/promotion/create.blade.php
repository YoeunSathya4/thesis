@extends ($route.'.main')
@section ('section-title', 'Create New Promotion')
@section ('section-css')
...
@section ('section-js')
	<script>
		...
		$("#image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="http://via.placeholder.com/360x300" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be 360x300 with .jpg or .png type</i></span>',
