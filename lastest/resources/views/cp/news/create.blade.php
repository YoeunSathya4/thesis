...
@section ('section-js')
	<script>
		...
		$("#image").fileinput({
		    ...
		    defaultPreviewContent: '<img src="http://via.placeholder.com/262x205" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be 262x205 with .jpg or .png type</i></span>',
	...
	<script>
		...
		$("#image-detail").fileinput({
		    ...
		    elErrorContainer: '#kv-avatar-errors-2',
		    msgErrorClass: 'alert alert-block alert-danger',
		    defaultPreviewContent: '<img src="http://via.placeholder.com/848x475" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be 848x475 with .jpg or .png type</i></span>',
		    layoutTemplates: {main2: '{preview} ' +  btnCust + ' {remove} {browse}'},
		    allowedFileExtensions: ["jpg", "png", "gif"]
		});
