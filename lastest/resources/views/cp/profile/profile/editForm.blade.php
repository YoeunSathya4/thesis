...
@section ('tab-js')
	...
	<script>
		...
		$("#avatar").fileinput({
		    ...
		    defaultPreviewContent: '<img src="{{ asset('public/uploads/user/image/'.$data->avatar) }}" alt="Missing Image" class="img img-responsive"><span class="text-muted">Click to select <br /><i style="font-size:12px">Image dimesion must be 200x165 with .jpg or .png type</i></span>',
