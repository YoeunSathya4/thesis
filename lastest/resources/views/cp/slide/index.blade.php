...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-2">
		<div class="form-group">
			...
			<input  type="text" class="form-control" id="key" placeholder="Slide Name" value="{{ isset($appends['key'])?$appends['key']:'' }}">
		</div>
	</div>
				...
				<tbody>
					...
					@foreach ($data as $row)
						<tr>
							...
							<td>
								@if($row->image!="")
									<img src="{{ asset ('public/uploads/slide/image/'.$row->image) }}" style="max-width:250px" alt="" data-toggle="tooltip" data-placement="bottom" title="{{ $row->name }}">
								@else
									No Image Avaiable
								@endif
