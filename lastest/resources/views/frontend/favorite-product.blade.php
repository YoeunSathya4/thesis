			                        ...
			                        <table class="table table-condensed">
			                            ...
			                            <tbody>
			                                ...
			                                <tr>
			                                    ...
			                                    <td class="text-right"> <a href="{{route('add-to-cart',['locale'=>$locale, 'id'=>$row->product_id])}}" type="button" class="btn btn-primary btn-sm">{{__('general.add-to-cart')}}</a> <a href="{{route('remove-from-favorite',['locale'=>$locale, 'id'=>$row->product_id])}}" type="button" class="btn btn-danger btn-sm">Remove Favorite</a></td>
